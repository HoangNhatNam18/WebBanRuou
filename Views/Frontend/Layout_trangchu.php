...
<header class="onshop-header">
    ...
    <div class="onshop-header__menu">
        <div class="onshop-header__logo">
            <a href="index.php?controller=Home"><img src="Assets/Frontend/images/svg2/logo.png" alt="Logo"></a>
        </div>
...
<ul class="onshop-menu--sub onshop-hidden-md">
                ...
                <li class="onshop-menu--sub__item"><a class="onshop-menu--sub__link" href="index.php?controller=ProductCategory&id=1">Vang Chile
                </a></li>
                <li class="onshop-menu--sub__item"><a class="onshop-menu--sub__link" href="index.php?controller=ProductCategory&id=2">Vang Úc
                </a></li>
                <li class="onshop-menu--sub__item"><a class="onshop-menu--sub__link" href="index.php?controller=ProductCategory&id=3">Vang Pháp
                </a></li>
                <li class="onshop-menu--sub__item"><a class="onshop-menu--sub__link" href="index.php?controller=ProductCategory&id=4">Vang Đà Lạt
                </a></li>
    </ul>
    <div class="onshop-block-slideshow">
        <img class="d-block w-100 img-slide-top-content onshop-block-banner-1" src="Assets/Frontend/images/slider_1.jpg"
             alt="First slide">
        <img class="d-block w-100 img-slide-top-content onshop-block-banner-2" src="Assets/Frontend/images/slider_2.jpg" alt="First slide">
        <img class="d-block w-100 img-slide-top-content onshop-block-banner-3" src="Assets/Frontend/images/slider_3.jpg" alt="First slide">
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                <article class="onshop-post">
                    <div class="onshop-post-img">
                        <img src="Assets/Frontend/images/pedro-summer-20190529-2.jpg" alt="">
                    </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                <article class="onshop-post">
                    <div class="onshop-post-img">
                        <img src="Assets/Frontend/images/beautiful-beauty-black-friday-972995.jpg" alt="">
                    </div>
                    <div class="onshop-post-info">
                        <a href="detail-post.html" class="title">
                            TRẢI NGHIỆM “HẾT MÌNH” LỄ HỘI FIESTA ĐẦY MÀU SẮC THÔNG QUA BST MÙA HÈ 2019 CỦA PEDRO
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="onshop-slide-brand">
                    <img class="d-block w-100 img-slide-brand" src="Assets/Frontend/images/Group%203.png" alt="First slide">
                    <img class="d-block w-100 img-slide-brand" src="Assets/Frontend/images/Group%204.png" alt="First slide">
                    <img class="d-block w-100 img-slide-brand" src="Assets/Frontend/images/Group%205.png" alt="First slide">
                    <img class="d-block w-100 img-slide-brand" src="Assets/Frontend/images/Group%206.png" alt="First slide">
                    <img class="d-block w-100 img-slide-brand" src="Assets/Frontend/images/Group%207.png" alt="First slide">
                    <img class="d-block w-100 img-slide-brand" src="Assets/Frontend/images/Group%203.png" alt="First slide">
                    <img class="d-block w-100 img-slide-brand" src="Assets/Frontend/images/Group%204.png" alt="First slide">
                </div>
            </div>
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="onshop-footer__content">
                    <div class="onshop-footer__content__top">
                        <img class="onshop-footer__logo" style="width: 200px;" src="Assets/Frontend/images/svg2/logo.png" alt="">
