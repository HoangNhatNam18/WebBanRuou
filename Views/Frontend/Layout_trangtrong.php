    ...
    <div class="onshop-header__menu product-detail">
        ...
        <div class="d-flex flex-row w-100 h-100 onshop-flex-1">
            <div class="d-flex flex-row w-100 h-100">
                ...
                <div class="onshop-block-title-header-scroll onshop-hidden">
                    <h1 class="title"><?php echo $record->name;?></h1>
                    <div class="header-scroll-cost">
                        <span class="cost-present"><?php echo $record->price;?>đ</span>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="onshop-footer__content">
                    <div class="onshop-footer__content__top">
                        <img class="onshop-footer__logo" src="Assets/Frontend/images/svg2/logo.png" alt="">
